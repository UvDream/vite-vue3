...
export interface lunarCalendarItem {
    ...
    lunarDayNumber: number,//农历日数字
    lunarMonthNumber: number,//农历月数字
    lunarYearNumber: number,//农历年数字
    lunarDate: String,
    gzDay: String,
    gzMonth: String,
    gzYear: String
...
class CalendarConversion {
     ...
     * 农历1900-2100的润大小信息表
     */
    public lunarInfo = [0x04bd8, 0x04ae0, 0x0a570, 0x054d5, 0x0d260, 0x0d950, 0x16554, 0x056a0, 0x09ad0, 0x055d2,//1900-1909
     ...
     */
    public Gan = ["\u7532", "\u4e59", "\u4e19", "\u4e01", "\u620a", "\u5df1", "\u5e9a", "\u8f9b", "\u58ec", "\u7678"]
    /**
     * 天干地支之地支速查表
     * @Array ["子","丑","寅","卯","辰","巳","午","未","申","酉","戌","亥"]
     */
    public Zhi = ["\u5b50", "\u4e11", "\u5bc5", "\u536f", "\u8fb0", "\u5df3", "\u5348", "\u672a", "\u7533", "\u9149", "\u620c", "\u4ea5"]
    /**
     * 天干地支之地支速查表<=>生肖
     * @Array ["鼠","牛","虎","兔","龙","蛇","马","羊","猴","鸡","狗","猪"]
     */
    public Animals = ["\u9f20", "\u725b", "\u864e", "\u5154", "\u9f99", "\u86c7", "\u9a6c", "\u7f8a", "\u7334", "\u9e21", "\u72d7", "\u732a"]
    /**
   * 24节气速查表
   * @Array ["小寒","大寒","立春","雨水","惊蛰","春分","清明","谷雨","立夏","小满","芒种","夏至","小暑","大暑","立秋","处暑","白露","秋分","寒露","霜降","立冬","小雪","大雪","冬至"]
   */
    public solarTerm = ["\u5c0f\u5bd2", "\u5927\u5bd2", "\u7acb\u6625", "\u96e8\u6c34", "\u60ca\u86f0", "\u6625\u5206", "\u6e05\u660e", "\u8c37\u96e8", "\u7acb\u590f", "\u5c0f\u6ee1", "\u8292\u79cd", "\u590f\u81f3", "\u5c0f\u6691", "\u5927\u6691", "\u7acb\u79cb", "\u5904\u6691", "\u767d\u9732", "\u79cb\u5206", "\u5bd2\u9732", "\u971c\u964d", "\u7acb\u51ac", "\u5c0f\u96ea", "\u5927\u96ea", "\u51ac\u81f3"]
    /**
     * 1900-2100各年的24节气日期速查表
     */
    public sTermInfo = ['9778397bd097c36b0b6fc9274c91aa', '97b6b97bd19801ec9210c965cc920e', '97bcf97c3598082c95f8c965cc920f',
    ...
    */
     ...
     * 
     */
    public nStr1 = ["\u65e5", "\u4e00", "\u4e8c", "\u4e09", "\u56db", "\u4e94", "\u516d", "\u4e03", "\u516b", "\u4e5d", "\u5341"]
    /**
     * 日期转农历称呼速查表
     * ['初','十','廿','卅']
     */
    public nStr2 = ["\u521d", "\u5341", "\u5eff", "\u5345"]
    /**
     * 月份转农历称呼速查表
     * ['正','一','二','三','四','五','六','七','八','九','十','冬','腊']
     */
    public nStr3 = ["\u6b63", "\u4e8c", "\u4e09", "\u56db", "\u4e94", "\u516d", "\u4e03", "\u516b", "\u4e5d", "\u5341", "\u51ac", "\u814a"]
    /**
    * 返回默认的阳历节日
    */
    getFestival() {
   ...
   */
    ...
    */
    ...
    /**
      ...
      * @return JSON object
      */
    lunar(y: number, m: number, d: number): lunarCalendarItem { //参数区间1900.1.31~2100.12.31
        ...
        return {
            lunarDate: lunarDate,
            lunarDay: this.toChinaDay(day),
            lunarMonth: (isLeap ? "\u95f0" : '') + this.toChinaMonth(month),
            lunarYear: this.toChinaDay(day),
            chineseZodiac: this.getAnimal(year),
            constellation: astro,
            lunarDayNumber: day,
            lunarMonthNumber: month,
            lunarYearNumber: year,
            gzDay: gzD,
            gzMonth: gzM,
            gzYear: gzY
        };
...
export default CalendarConversion